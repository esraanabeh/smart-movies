...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active {{$pull}}">{{trans('admin.gallery_add')}}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{trans('admin.gallery_add')}}</h3>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            {{-- <div   class="form-group row">
                                ...
                                <div  class="col-sm-8">
                                    {{ Form::select('type',['image'=>trans('admin.image') , 'video'=>trans('admin.video')], null, ['class'=>'form-control select2','id'=>'type']) }}
                                    @if($errors->has('type'))
                             ...
                             <div id ="ar_title" class="form-group row">
                                <label for="ar_title"
                                       class="col-sm-4 col-form-label ar_title">{{trans('admin.ar_title')}}
                        ...
                        <div id ="en_title" class="form-group row">
                            <label for="en_title"
                                   class="col-sm-4 col-form-label en_title">{{trans('admin.en_title')}}
                                <span dir="ltr"></span></label>
                        <div class="col-sm-8">
                            ...
                            <div id ="video" class="form-group row">
                                <label for="file"
                                       class="col-sm-4 col-form-label file">{{trans('admin.video')}}
                                    <span dir="ltr"></span></label>
                            <div class="col-sm-8">
