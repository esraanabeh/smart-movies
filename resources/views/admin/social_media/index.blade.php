        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{URL::to('admin/social_media/create')}}" class="btn btn-lg bg-black">{{trans('admin.social_media_add')}}</a>
                </div>
                <div class="box-body">
                    <table id="{{$datatable}}" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('social_media.destroy',$one->id)}}" method="POST">
                                        @method('DELETE')
                                        @csrf
