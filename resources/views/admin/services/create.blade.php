...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.service_add')}}</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin.service_add')}}</h3>
        ...
        <form action="{{URL::to('admin/services')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
