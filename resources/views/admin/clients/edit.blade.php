...
<section class="content-header">
    <h1>
        {{trans('admin.client_edit')}}
    </h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item {{$pull}}"><a href="{{URL::to('admin')}}"> {{trans('admin.home')}}</a></li>
        <li class="breadcrumb-item {{$pull}}"><a href="{{URL::to('admin/client')}}"> {{trans('admin.client')}}</a></li>
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.client_edit')}}</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin.client_edit')}} : {{$client[$lang.'_name']}}</h3>
        ...
        <form action="{{URL::to('admin/clients/'.$client['id'])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('ar_name', $client['ar_name'], ['class'=>'form-control','id'=>'ar_name']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('en_name', $client['en_name'], ['class'=>'form-control','id'=>'en_name']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 custom-file" style="height: auto">
                                ...
                                <img src="{{URL::to('logo/'.$client['logo'])}}" id="previewImg" alt="logo"
                        ...
                        @if($client['id '] == 1)
                        <div class="form-group row">
                            <label for="logo" class="col-sm-3 col-form-label logo">{{trans('admin.logo')}} (650px * 650px)</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="input_4" class="col-sm-3 col-form-label logo_current_ar">{{trans('admin.logo_current')}}</label>
                            <div class="col-sm-9">
                                <img src="{{URL::to('logo/'.$client['logo'])}}" class="img-thumbnail logo_current">
                            </div>
                        </div>
                        @endif
