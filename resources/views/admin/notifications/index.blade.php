                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                {{-- <div class="form-group row">
                                    <label for="image" class="col-sm-3 col-form-label">{{trans('admin.image')}}</label>
                                    <div class="col-sm-9">
                                        {{ Form::file('image',['class'=>'form-control','id'=>'image']) }}
                                        <p style="color:#f00;" dir='ltr'>300 KB - PNG - 800px x 400px</p>
                                        @if($errors->has('image'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    ...
                                    <img class="img-thumbnail" style="height: 50px" src="{{URL::to('upload/notifications/'.$notification['image'])}}">
                                    @endif
                                </td>
                                <td style="vertical-align: middle;">{{$notification['User'] ? $notification['User']['first_name'].' '.$notification['User']['last_name'] : ''}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
