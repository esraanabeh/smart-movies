...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.movies')}}</li>
    </ol>
</section>
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{URL::to('admin/movies/create')}}" class="btn btn-lg bg-black">{{trans('admin.member_add')}}</a>
                    ...
                    <table id="{{$datatable}}" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$i}}</td>
                                <td>{{$movie['name']}}</td>
                                <td> <img src="{{URL::to('image/'.$movie['image'])}}" style="height: 80px; width: 100px;"/></td>
                                <td><video style="height: 80px; width: 100px;" controls> 
                                ...
                                <td>
                                    {{ Form::open(array('url' =>'admin/movies/'.$movie->id.'/edit', 'method' => 'GET')) }}
