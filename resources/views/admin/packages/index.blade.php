...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.packages')}}</li>
    </ol>
</section>
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{URL::to('admin/packages/create')}}" class="btn btn-lg bg-black">{{trans('admin.member_add')}}</a>
                    ...
                    <table id="{{$datatable}}" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$i}}</td>
                                <td>{{$package['name']}}</td>
                                <td> <img src="{{URL::to('image/'.$package['image'])}}" style="height: 80px; width: 100px;"/></td>
                                <td>{{$package['rate']}}</td>
                                <td style="vertical-align: middle;">
                                    @if($package['is_discount']==1)
                                        {{ number_format($package['price_after_discount'] ) }}
                                ...
                                <td>
                                    {{ Form::open(array('url' =>'admin/packages/'.$package->id.'/edit', 'method' => 'GET')) }}
