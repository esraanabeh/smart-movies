...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active {{$pull}}">{{trans('admin.slider_edit')}}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{trans('admin.slider_edit')}} : {{$slider[$lang.'_name']}}</h3>
            ...
            <form action="{{URL::to('admin/slider/'.$slider->id)}}" method="post" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::select('active',['yes'=>trans('admin.yes_active') , 'no'=>trans('admin.no_active')] ,$slider['active'], ['class'=>'form-control','id'=>'active']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::number('sort', $slider['sort'], ['min' => '0','class'=>'form-control','id'=>'sort']) }}
                                    @if($errors->has('sort'))
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::text('link', $slider['link'], ['class'=>'form-control','id'=>'link']) }}
                                    @if($errors->has('link'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::text('ar_name', $slider['ar_name'], ['class'=>'form-control','id'=>'ar_name']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::text('en_name', $slider['en_name'], ['class'=>'form-control','id'=>'en_name']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::text('ar_title', $slider['ar_title'], ['class'=>'form-control','id'=>'ar_title']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::text('en_title', $slider['en_title'], ['class'=>'form-control','id'=>'en_title']) }}
                            ...
                            <div class="form-group row">
                                <label for="input_4"
                                       class="col-sm-4 col-form-label image_current_ar">{{trans('admin.image_ar_current')}}</label>
                                <div class="col-sm-8">
                                    <img src="{{URL::to('upload/slider/'.$slider['ar_image'])}}"
                            ...
                            <div class="form-group row">
                                <label for="input_4"
                                       class="col-sm-4 col-form-label image_current_ar">{{trans('admin.image_en_current')}}</label>
                                <div class="col-sm-8">
                                    <img src="{{URL::to('upload/slider/'.$slider['en_image'])}}"
                                         width="150px" height="150px"  class="img-thumbnail image_current">
                                </div>
                            </div> --}}
...
@section('scripts')
    <script>
        ...
        $("body").on("change", "#type", function (e) {
            var type = $('#type').val();
            if (type == "web") {
                $('.image-ar').html('<?php echo trans('admin.image_ar'); ?> <span dir="ltr">(Width: 1930px *  Height:840px)</span>');
                $('.image-en').html('<?php echo trans('admin.image_en'); ?> <span dir="ltr">(Width: 1930px *  Height:840px)</span>');
            } else {
                $('.image-ar').html('<?php echo trans('admin.image_ar'); ?> <span dir="ltr">(Width: 375px * Height:1250px)</span>');
                $('.image-en').html('<?php echo trans('admin.image_en'); ?> <span dir="ltr">(Width: 375px * Height:1250px)</span>');
            }
        });
        ...
        $(document).ready(function () {
            ...
            if (type == "web") {
                ...
                $('.image-en').html('<?php echo trans('admin.image_ar'); ?> <span dir="ltr">(Width: 375px * Height:1250px)</span>');
                $('.image-en').html('<?php echo trans('admin.image_en'); ?> <span dir="ltr">(Width: 375px * Height:1250px)</span>');
            }
