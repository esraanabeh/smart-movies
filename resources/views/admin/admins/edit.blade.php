...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item {{$pull}}"><a href="{{URL::to('admin/admins')}}"> {{trans('admin.admins')}}</a></li>
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.admin_edit')}}</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin.admin_edit')}} :  {{$admin['name']}}</h3>
        ...
        <form action="{{URL::to('admin/admins/'.$admin['id'])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label for="ar_name" class="col-sm-3 col-form-label">{{trans('admin.name')}}</label>
                            <div class="col-sm-9">
                                {{ Form::text('ar_name', $admin['ar_name'], ['class'=>'form-control','id'=>'ar_name']) }}
            ...
            <div class="box-footer">
                ...
                <a href="{{URL::to('admin/admins')}}" class="btn btn-default btn-lg" style="font-size: 16px;">{{trans('admin.back')}}</a>
            </div>
